...
## 1. For Michele to forward

Short on purpose. She should be able to send it without editing, and it should
not read like advertising copy she has been handed.

> **Subject: The guy who built our website**
>
> Hi [Name],
>
> A few people have asked who did our new website — his name is Stephen
> Psaradellis, and he built chicagostreetmarkets.com from scratch.
>
> He's a software engineer by trade (his day job is building systems for big
> banks and food companies) and he does small business websites on the side.
> They're built by hand rather than from a template, so they load fast, and
...
## 2. Your reply when a vendor bites
...
> new site from me, if that's the honest answer.
>
> Are you around [day] or [day]?
>
> Stephen Psaradellis
> 224-715-3678 · shortforge.dev/websites

---

## 3. The note to Michele herself

Send this **before** she forwards anything, so the referral arrangement is
settled and she isn't guessing what to say about price.

> Michele — two things before you send this to anyone.
>
> First, the arrangement. Looking after your site is on me permanently; you
> never get a bill for it. And if a vendor you introduce hires me, I'll send you
> $150. I'd rather that be stated plainly than have it feel like you're doing
> free sales work.
>
> Second, if anyone asks what you paid: the honest answer is nothing. I built
> yours to prove the approach and get a real site out in the world, and that's
> what I'll tell them too. It isn't a secret — it just isn't the going rate.
>
> Send it to whoever you think would actually want it. No pressure to send it
> to everyone.
...
- **The AI phone agent is not in the vendor pitch on purpose.** Sell it on the
  call, and only to people who take orders or bookings by phone — caterers,
  bakeries, food trucks. Offering it to everyone makes the whole thing sound
  like an upsell.
- **Capacity is the real limit.** Care plans are a standing weekly obligation on
  top of a full-time job; the $250 season change is the product to push, since
  it batches the same work into two predictable weeks a year.
