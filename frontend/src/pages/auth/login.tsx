      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <p className="text-secondary-400">
            Sign in to your ShortForge account
          </p>
        </motion.div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-secondary-900 text-secondary-400">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center py-2 px-4 border border-secondary-700 rounded-lg shadow-sm bg-secondary-800 text-sm font-medium text-secondary-300 hover:bg-secondary-700 transition-colors"
              >
